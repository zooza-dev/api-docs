...
description: The Zooza registration and booking form widget — settings, initialisation options, analytics events, and callbacks.
sidebar_position: 2
---
...
Probably the most important setting there is. This will let Zooza know where your widget resides so that it can [redirect your customers](index.md#importance-of-a-url) to it when necessary.
