...
Tasks:
1. Tell me exactly where in my page to place this snippet (this is a logged-in members area). Both lines can stay together in the <body>, or the loader <script> can move into <head> so the widget starts loading earlier — recommend what fits my site.
